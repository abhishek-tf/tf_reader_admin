...
/**
 * The catalogue-wide Publishers page — every publisher, filterable by status and institution.
 * SUPER_ADMIN only: a PUBLISHER_ADMIN is scoped to one publisher, which has nothing to filter
 * or browse, so PublishersScreen sends that role to MyPublisherScreen instead of here.
 */
export default function PublisherCatalogueScreen() {
